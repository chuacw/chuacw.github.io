...
{
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("listBackgroundColor", Color.Empty)) %>;
}
    
dl.entrylist dd
{
    background-image: <%= UrlOrNone(themeData.GetUrlValue("listBackgroundImage", null))%>;
}

.entryview
{
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("postBackgroundColor", Color.Empty)) %>;
    background-image: <%= UrlOrNone(themeData.GetUrlValue("postBackgroundImage", null))%>;
}
