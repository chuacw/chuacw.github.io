    ...
    <div class="post">
        <div class="postsublist">
            ...
            <div class="postfoot">
                ...
                <CSBlog:WeblogPostRating ID="WeblogPostRating1" runat="server" RatingCssClass="CommonRateControl" RatingReadOnlyCssClass="CommonRateControlReadOnly" RatingActiveCssClass="CommonRateControlActive" ImagesBaseUrl="~/utility/images/" />          
                ...
                <CSBlog:WeblogPostData ID="WeblogPostData1" LinkTo="PostEditor" ResourceName="Weblog_Link_Edit" runat="server" />                   
            </div>
        </div>
    </div>
    ...
    <CSControl:PlaceHolder runat="server">
        ...
        <ContentTemplate>
            <CSBlog:WeblogFeedbackList runat="server">
                ...
                <HeaderTemplate>        
                    <CSControl:ResourceControl runat="server" ResourceName="Weblog_CommentForm_Comments" Tag="H3" class="pageTitle" />
                    <div id="comments">
	            </HeaderTemplate>
	            <ItemTemplate>
            ...
            >
                ...
                <FormTemplate>
                    <div id="commentform">
                    <CSControl:ResourceControl runat="server" ResourceName="Weblog_CommentForm_WhatDoYouThink" id="rc_think" Tag="h3" class="pageTitle" />
	                    <dl>
