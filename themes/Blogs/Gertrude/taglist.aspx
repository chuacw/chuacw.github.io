...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <CSBlog:WeblogPostList runat="server">
        ...
        <ItemTemplate>
             <div class="post">
               <CSBlog:WeblogPostData Property="UserTime" LinkTo="Post" FormatString="ddd, d MMM yyyy @ h:mm tt" IncludeTimeInDate="true" runat="server" Tag="div" CssClass="postsubhead" />
               <div class="postsub">
