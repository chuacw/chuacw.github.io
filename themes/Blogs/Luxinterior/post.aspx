    ...
    <div class="post">
        <div class="posthead">
            ...
            <h2>
                ...
                <CSBlog:WeblogPostRating runat="server" RatingCssClass="ratemenu" RatingReadOnlyCssClass="CommonRateControlReadOnly" RatingActiveCssClass="CommonRateControlActive" ImagesBaseUrl="~/utility/images/" />
            </h2>
        </div>        
            ...
            <CSBlog:WeblogPostTagEditableList runat="server" EditorLinkCssClass="TextButton" EditorCssClass="InlineTagEditor" />
    </div>
