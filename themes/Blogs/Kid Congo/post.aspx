...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <div class="entryview">
        <CSBlog:WeblogPostData Property="UserTime" LinkTo="Post" FormatString="dd MMMM yyyy" runat="server" CssClass="entryviewdate" Tag="div" />
        ...
        <div class="entrylistfooter">
            <CSBlog:WeblogPostTagEditableList runat="server" id="InlineTagEditorPanel" EditorLinkCssClass="TextButton" EditorCssClass="InlineTagEditor" Tag="Div" CssClass="filedunder clearfix" />                    
                ...
                <ItemTemplate>
                        <dt class="<%# ((bool) Eval("IsOwner")) ? "owner" : "comment" %>">
				            ...
				            <CSBlog:WeblogPostFeedbackData runat="server" Property="DisplayName" LinkTo="User">
				                <TrailerTemplate> said:</TrailerTemplate>
			            ...
			            <dd class="<%# ((bool) Eval("IsOwner")) ? "owner" : "comment" %>">
			                ...
			                <div class="commentsfooter">
			                    <CSBlog:DeleteWeblogPostFeedbackForm DeleteButtonId="DeleteComment" ConfirmationResourceName="Weblog_Comment_DeleteVerify" runat="server" CssClass="floatright">
			                        <SuccessActions>
            ...
            >
                ...
                <FormTemplate>
                    ...
                    <dl class="commentform">
                        ...
                        <dd><asp:TextBox id="tbComment" runat="server" Rows="5" Columns="25" CssClass="textmultiline" TextMode="MultiLine" ValidationGroup="CreateCommentForm" /></dd>
