...
#header p
{
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("siteTitleBorderColor", Color.Empty))%>;
}
...
#sidebar-a a:link
{
    ...
    border-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("sidebarBackgroundColor", Color.Empty))%>;
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("sidebarBackgroundColor", Color.Empty))%>;
}
...
#sidebar-a a:active, #sidebar-a a:hover
{
    ...
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("sidebarActiveLinkBackgroundColor", Color.Empty))%>;
    border-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("sidebarActiveLinkBorderColor", Color.Empty))%>;
}
...
#content
{
    margin-left: <%= themeData.GetUnitValue("sidebarWidth", Unit.Parse("180px")) %>;;
}

#sidebar-a
{
    width: <%= themeData.GetUnitValue("sidebarWidth", Unit.Parse("180px")) %>;;
}
