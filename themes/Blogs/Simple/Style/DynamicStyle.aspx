...
.postsubhead
{
    background-color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("postHeaderBackgroundColor", Color.Empty)) %>;
    color: <%= ColorTranslator.ToHtml(themeData.GetColorValue("postHeaderColor", Color.Empty)) %>;
    font-family: <%= themeData.GetStringValue("postHeaderFont", "")%>;
    font-size: <%= themeData.GetStringValue("postHeaderFontSize", "")%>;
}
...
#content
{
    margin-left: <%= themeData.GetUnitValue("sidebarWidth", Unit.Parse("220px")) %>;;
}
