...
<%@ Register Src="forum-thread-questionandanswerview-post.ascx" TagPrefix="CSUserControl" TagName="Post" %>
        ...
        <div class="CommonContentBox" style="background-color: #CCFFCC; border-top-color: #339900;">  
            <div class="CommonContentBoxContent"> 
                <h4 class="CommonContentBoxHeader VerifiedAnswers" style="color: #339900; border-bottom-color: #339900;">
                    ...
                    <CSControl:ResourceControl ResourceName="PostQuestionAnswerView_AllVerifiedAnswers" runat="server" />
                </h4>
    </HeaderTemplate>
    <ItemTemplate>
...
<CSForum:ForumPostList runat="server">
    ...
    <div class="CommonContentBoxFooter">
        ...
        <CSControl:Pager runat="server" id="PagerQnA" ShowTotalSummary="true" Visible="true" CssClass="CommonPager">
