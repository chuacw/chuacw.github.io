                        ...
                        <CSControl:ConditionalContent runat="server">
                            ...
                            <div class="CommonCommentBubble">
                                ...
                                <div class="CommonCommentContent">
                                    <CSBlog:DeleteWeblogPostFeedbackForm DeleteButtonId="DeleteComment" Tag="Div" CssClass="CommonMessageActions" runat="server">
...
<asp:Content ContentPlaceHolderID="rcrc" runat="server">
    ...
    <CSControl:PlaceHolder runat="server" Tag="UL" CssClass="CommonContentBoxList Seperator">
        ...
        <ContentTemplate>
            <CSBlog:WeblogPostData runat="server" LinkTo="PostEditor" ResourceName="Hubs_EditPost" Tag="Li" />
            <CSBlog:DeleteWeblogPostForm runat="server" DeleteButtonId="Delete" Tag="Li">
                <SuccessActions><CSControl:GoToCurrentContentContainerAction runat="server" /></SuccessActions>
                <FormTemplate><CSControl:ResourceLinkButton runat="server" ID="Delete" ResourceName="Hubs_DeletePost" OnClientClick="if (!confirm('Are you sure you want to delete this post?\n(this action cannot be undone)')) { return false; }" /></FormTemplate>
